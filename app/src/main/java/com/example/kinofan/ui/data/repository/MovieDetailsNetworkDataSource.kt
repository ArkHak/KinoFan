...
class MovieDetailsNetworkDataSource(
    ...
    private val _downloaderMovieDetailsResponse = MutableLiveData<MovieDetails>()
    val downloaderMovieResponse: LiveData<MovieDetails>
        get() = _downloaderMovieDetailsResponse
        ...
        try {
            compositeDisposable.add(
                apiService.getMovieDetails(movieId)
                    ...
                    .subscribe(
                        {
                            _downloaderMovieDetailsResponse.postValue(it)
